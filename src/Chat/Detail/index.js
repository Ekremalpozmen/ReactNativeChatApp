...
export default class Index extends Component {
    ...
    static navigationOptions = ( { navigation }) => {
        return {
            ...
            headerRight:(navigation.getParam("userId")== navigation.getParam("roomUserId")) ?<TouchableOpacity 
            onPress={ navigation.getParam("_handleDelete")}
            style={{marginRight:15,padding:5}}><Icon name={'trash'} size={25 } color={'red'}/></TouchableOpacity> : null
        }
    }
